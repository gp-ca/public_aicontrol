...
print("Parameter optimization of RFC")
###########################################################################
# RFC parameter optimization using grid search
###########################################################################
...
param_grid = [
    {
        'classifier__n_estimators': [20, 70, 120, 200, 400],
...
rfc_grid_search_results = pd.concat(res)
